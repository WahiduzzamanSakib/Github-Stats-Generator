...
const StatsCard = ({ username, theme, statsHost, darkMode }) => {
  ...
  const statsThemeParams = darkMode
    ? "bg_color=0f172a&title_color=f8fafc&text_color=94a3b8&icon_color=6366f1"
    : "bg_color=ffffff&title_color=0f172a&text_color=334155&icon_color=4f46e5";

  // Construct the URL
  const cardUrl = `${currentHost}/api?username=${username}&show_icons=true&theme=${cardTheme}&${statsThemeParams}&hide_border=true`;
